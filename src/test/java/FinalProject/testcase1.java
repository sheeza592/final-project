...
public class testcase1 {
	...
	public void adduser() throws InterruptedException 
	{
	   ...
	   driver.findElement(By.xpath("/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[1]/div/div[1]/div/div[2]/div/div/div[1]")).click();
	    ...
	    driver.findElement(By.xpath("/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[1]/div/div[2]/div/div[2]/div/div/input")).sendKeys("C");
	    Thread.sleep(2000);
		driver.findElement(By.xpath("//label[text()=\"Employee Name\"]/../..//div[@role='option']")).click();
	    Thread.sleep(2000);
	    driver.findElement(By.xpath("/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[1]/div/div[4]/div/div[2]/input")).sendKeys("Charlie");
	    Thread.sleep(2000);
	    ...
	    Thread.sleep(2000);
	    driver.findElement(By.xpath("/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[2]/div/div[2]/input")).sendKeys("john123");
